...
// Constantes en tiempo de compilación para el estado de la actividad
...
class MainActivity : AppCompatActivity() {
    ...
    // Podemos recuperar el estado de la actividad en el onCreate(savedInstanceState: Bundle?)
    ...
    // Vamos a salvar el estadoo de la interfaz
    override fun onSaveInstanceState(outState: Bundle) {
        super.onSaveInstanceState(outState)

        Timber.i("onSaveInstanceState Called")
        // Salvamos el estado de la actividad
